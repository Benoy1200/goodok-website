...
export default function Header() {
    ...
    export default function Header() {
        ...
        return (
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#F7F3EA]/95 backdrop-blur-sm border-b border-[#E5E0D6]">
                item.hasDropdown ? (
                <div
                    key={item.name}
                    className="relative"
                            ...
                            <div className="bg-white rounded-lg shadow-lg border border-gray-100 py-2">
                                {productItems.map((product) => (
                                    <Link
                                        key={product.name}
                                        href={product.href}
                                        className="block px-4 py-2 text-gray-700 hover:bg-[#F7F3EA] hover:text-[var(--accent)] transition-colors"
                                    >
                                        {product.name}
                                    </Link>
                                ))}
