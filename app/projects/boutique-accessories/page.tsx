            ...
            <section className="bg-gradient-to-br from-rose-900 to-pink-700 text-white py-20">
                <div className="container">
                    <div className="max-w-4xl mx-auto">
                        <Link href="/projects" className="text-rose-300 hover:text-white mb-4 inline-block">
                            ← Back to Projects
                        </Link>
                        ...
                        <p className="text-xl text-rose-100 mb-6">
                            Tokyo, Japan · Fashion Boutique · 120㎡
                        </p>
            ...
            <section className="py-20">
                <div className="container">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            <div>
                                ...
                                <ul className="space-y-2 text-gray-600">
                                    ...
                                    <li>• Efficient use of 120㎡ space</li>
                        ...
                        {/* Featured Image */}
                        <div className="aspect-video bg-gradient-to-br from-rose-100 to-pink-100 rounded-xl flex items-center justify-center mb-12">
                        ...
                        <div className="bg-rose-50 rounded-xl p-8">
                            <div className="grid md:grid-cols-3 gap-8 text-center">
                                <div>
                                    <div className="text-4xl font-bold text-rose-600 mb-2">Premium</div>
                                ...
                                <div>
                                    <div className="text-4xl font-bold text-rose-600 mb-2">97%</div>
